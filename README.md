...
To align with the lo-fi visual direction, I used a 64×64-pixel resolution and trained the full 821-image dataset for 10 epochs. Although I tried increasing training to 20 epochs to improve clarity, it keeps exceeded the Colab GPU limit. Therefore, I kept 10 epochs as the final setting.
